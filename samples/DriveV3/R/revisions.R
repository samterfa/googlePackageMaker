	...
	#'
	#' You can only delete revisions for files with binary content in Google Drive, like images or videos. Revisions for other files, like Google Docs or Sheets, and the last remaining file version can't be deleted. Autogenerated via \code{\link[googlePackageMaker]{make_google_package}}.
	#'
