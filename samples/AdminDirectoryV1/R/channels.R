	...
	#' @export
	channels.stop <- function(token = NULL, params = NULL, type = NULL, kind = NULL, id = NULL, address = NULL, resourceId = NULL, payload = NULL, expiration = NULL, resourceUri = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['admin.channels.stop']]$scopes), return_response = F){
