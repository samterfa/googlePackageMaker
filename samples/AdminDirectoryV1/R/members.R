	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	members.insert <- function(groupKey, role = NULL, kind = NULL, type = NULL, status = NULL, email = NULL, etag = NULL, id = NULL, delivery_settings = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.members.insert']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	members.list <- function(groupKey, pageToken = NULL, maxResults = NULL, includeDerivedMembership = NULL, roles = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.members.list']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	members.patch <- function(memberKey, groupKey, role = NULL, kind = NULL, type = NULL, status = NULL, email = NULL, etag = NULL, id = NULL, delivery_settings = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.members.patch']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	members.update <- function(memberKey, groupKey, role = NULL, kind = NULL, type = NULL, status = NULL, email = NULL, etag = NULL, id = NULL, delivery_settings = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.members.update']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
