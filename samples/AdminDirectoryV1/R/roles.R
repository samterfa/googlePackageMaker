	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	roles.insert <- function(customer, roleDescription = NULL, kind = NULL, roleId = NULL, isSystemRole = NULL, etag = NULL, isSuperAdminRole = NULL, rolePrivileges = NULL, roleName = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.roles.insert']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	roles.patch <- function(customer, roleId, roleDescription = NULL, kind = NULL, isSystemRole = NULL, etag = NULL, isSuperAdminRole = NULL, rolePrivileges = NULL, roleName = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.roles.patch']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	roles.update <- function(roleId, customer, roleDescription = NULL, kind = NULL, isSystemRole = NULL, etag = NULL, isSuperAdminRole = NULL, rolePrivileges = NULL, roleName = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.roles.update']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
