	...
	users.delete <- function(userKey, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.users.delete']]$scopes), return_response = F){
		...
		req <- gargle::request_develop(endpoint = .endpoints[['directory.users.delete']], params = params)
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	users.get <- function(userKey, projection = NULL, viewType = NULL, customFieldMask = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.users.get']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
		req <- gargle::request_develop(endpoint = .endpoints[['directory.users.get']], params = params)
		req <- gargle::request_build(method = req$method, path = req$path, params = req$params, body = req$body, token = httr::config(token = gargle_token))
		res <- gargle::request_make(req, encode = 'json')
		if(return_response) return(res)
		httr::content(res)
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	users.insert <- function(organizations = NULL, id = NULL, notes = NULL, addresses = NULL, sshPublicKeys = NULL, externalIds = NULL, name = NULL, ims = NULL, orgUnitPath = NULL, locations = NULL, archived = NULL, keywords = NULL, password = NULL, changePasswordAtNextLogin = NULL, recoveryPhone = NULL, ipWhitelisted = NULL, posixAccounts = NULL, includeInGlobalAddressList = NULL, gender = NULL, languages = NULL, phones = NULL, relations = NULL, recoveryEmail = NULL, customSchemas = NULL, hashFunction = NULL, websites = NULL, suspended = NULL, primaryEmail = NULL, emails = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.users.insert']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
		req <- gargle::request_develop(endpoint = .endpoints[['directory.users.insert']], params = params)
		req <- gargle::request_build(method = req$method, path = req$path, params = req$params, body = req$body, token = httr::config(token = gargle_token))
		res <- gargle::request_make(req, encode = 'json')
		if(return_response) return(res)
		httr::content(res)
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	users.list <- function(showDeleted = NULL, domain = NULL, query = NULL, orderBy = NULL, pageToken = NULL, sortOrder = NULL, maxResults = NULL, projection = NULL, customFieldMask = NULL, viewType = NULL, customer = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.users.list']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
		req <- gargle::request_develop(endpoint = .endpoints[['directory.users.list']], params = params)
		req <- gargle::request_build(method = req$method, path = req$path, params = req$params, body = req$body, token = httr::config(token = gargle_token))
		res <- gargle::request_make(req, encode = 'json')
		if(return_response) return(res)
		httr::content(res)
	...
	users.makeAdmin <- function(userKey, status = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.users.makeAdmin']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
		req <- gargle::request_develop(endpoint = .endpoints[['directory.users.makeAdmin']], params = params)
		req <- gargle::request_build(method = req$method, path = req$path, params = req$params, body = req$body, token = httr::config(token = gargle_token))
		res <- gargle::request_make(req, encode = 'json')
		if(return_response) return(res)
		httr::content(res)
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	users.patch <- function(userKey, organizations = NULL, id = NULL, notes = NULL, addresses = NULL, sshPublicKeys = NULL, externalIds = NULL, name = NULL, ims = NULL, orgUnitPath = NULL, locations = NULL, archived = NULL, keywords = NULL, password = NULL, changePasswordAtNextLogin = NULL, recoveryPhone = NULL, ipWhitelisted = NULL, posixAccounts = NULL, includeInGlobalAddressList = NULL, gender = NULL, languages = NULL, phones = NULL, relations = NULL, recoveryEmail = NULL, customSchemas = NULL, hashFunction = NULL, websites = NULL, suspended = NULL, primaryEmail = NULL, emails = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.users.patch']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
		req <- gargle::request_develop(endpoint = .endpoints[['directory.users.patch']], params = params)
		req <- gargle::request_build(method = req$method, path = req$path, params = req$params, body = req$body, token = httr::config(token = gargle_token))
		res <- gargle::request_make(req, encode = 'json')
		if(return_response) return(res)
		httr::content(res)
	...
	users.signOut <- function(userKey, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.users.signOut']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
		req <- gargle::request_develop(endpoint = .endpoints[['directory.users.signOut']], params = params)
		req <- gargle::request_build(method = req$method, path = req$path, params = req$params, body = req$body, token = httr::config(token = gargle_token))
		res <- gargle::request_make(req, encode = 'json')
		if(return_response) return(res)
		httr::content(res)
	...
	users.undelete <- function(userKey, orgUnitPath = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.users.undelete']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
		req <- gargle::request_develop(endpoint = .endpoints[['directory.users.undelete']], params = params)
		req <- gargle::request_build(method = req$method, path = req$path, params = req$params, body = req$body, token = httr::config(token = gargle_token))
		res <- gargle::request_make(req, encode = 'json')
		if(return_response) return(res)
		httr::content(res)
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	users.update <- function(userKey, organizations = NULL, id = NULL, notes = NULL, addresses = NULL, sshPublicKeys = NULL, externalIds = NULL, name = NULL, ims = NULL, orgUnitPath = NULL, locations = NULL, archived = NULL, keywords = NULL, password = NULL, changePasswordAtNextLogin = NULL, recoveryPhone = NULL, ipWhitelisted = NULL, posixAccounts = NULL, includeInGlobalAddressList = NULL, gender = NULL, languages = NULL, phones = NULL, relations = NULL, recoveryEmail = NULL, customSchemas = NULL, hashFunction = NULL, websites = NULL, suspended = NULL, primaryEmail = NULL, emails = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.users.update']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
		req <- gargle::request_develop(endpoint = .endpoints[['directory.users.update']], params = params)
		req <- gargle::request_build(method = req$method, path = req$path, params = req$params, body = req$body, token = httr::config(token = gargle_token))
		res <- gargle::request_make(req, encode = 'json')
		if(return_response) return(res)
		httr::content(res)
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	users.watch <- function(maxResults = NULL, projection = NULL, viewType = NULL, sortOrder = NULL, event = NULL, customFieldMask = NULL, showDeleted = NULL, orderBy = NULL, domain = NULL, customer = NULL, pageToken = NULL, query = NULL, token = NULL, id = NULL, expiration = NULL, address = NULL, params = NULL, payload = NULL, resourceId = NULL, kind = NULL, resourceUri = NULL, type = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.users.watch']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
		req <- gargle::request_develop(endpoint = .endpoints[['directory.users.watch']], params = params)
		req <- gargle::request_build(method = req$method, path = req$path, params = req$params, body = req$body, token = httr::config(token = gargle_token))
		res <- gargle::request_make(req, encode = 'json')
		if(return_response) return(res)
		httr::content(res)
