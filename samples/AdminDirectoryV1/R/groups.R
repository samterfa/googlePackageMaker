	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	groups.insert <- function(adminCreated = NULL, etag = NULL, description = NULL, name = NULL, kind = NULL, nonEditableAliases = NULL, id = NULL, directMembersCount = NULL, email = NULL, aliases = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.groups.insert']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	groups.list <- function(customer = NULL, maxResults = NULL, domain = NULL, orderBy = NULL, query = NULL, sortOrder = NULL, userKey = NULL, pageToken = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.groups.list']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	groups.patch <- function(groupKey, adminCreated = NULL, etag = NULL, description = NULL, name = NULL, kind = NULL, nonEditableAliases = NULL, id = NULL, directMembersCount = NULL, email = NULL, aliases = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.groups.patch']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	groups.update <- function(groupKey, adminCreated = NULL, etag = NULL, description = NULL, name = NULL, kind = NULL, nonEditableAliases = NULL, id = NULL, directMembersCount = NULL, email = NULL, aliases = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.groups.update']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
