	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	chromeosdevices.get <- function(deviceId, customerId, projection = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.chromeosdevices.get']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	chromeosdevices.list <- function(customerId, orgUnitPath = NULL, sortOrder = NULL, projection = NULL, maxResults = NULL, orderBy = NULL, query = NULL, pageToken = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.chromeosdevices.list']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#'
	#' You can move up to 50 devices at once. Autogenerated via \code{\link[googlePackageMaker]{make_google_package}}.
	#'
	#' @seealso \href{http://developers.google.com/admin-sdk/}{Google Documentation}
	#'
	#' @details
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	chromeosdevices.moveDevicesToOu <- function(orgUnitPath, customerId, deviceIds = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.chromeosdevices.moveDevicesToOu']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	chromeosdevices.patch <- function(customerId, deviceId, projection = NULL, manufactureDate = NULL, annotatedLocation = NULL, etag = NULL, platformVersion = NULL, diskVolumeReports = NULL, activeTimeRanges = NULL, firmwareVersion = NULL, ethernetMacAddress0 = NULL, kind = NULL, deviceFiles = NULL, annotatedAssetId = NULL, macAddress = NULL, osVersion = NULL, status = NULL, cpuStatusReports = NULL, ethernetMacAddress = NULL, orderNumber = NULL, recentUsers = NULL, tpmVersionInfo = NULL, supportEndDate = NULL, lastSync = NULL, annotatedUser = NULL, notes = NULL, dockMacAddress = NULL, willAutoRenew = NULL, autoUpdateExpiration = NULL, orgUnitPath = NULL, bootMode = NULL, lastEnrollmentTime = NULL, model = NULL, serialNumber = NULL, systemRamTotal = NULL, lastKnownNetwork = NULL, systemRamFreeReports = NULL, meid = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.chromeosdevices.patch']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	chromeosdevices.update <- function(deviceId, customerId, projection = NULL, manufactureDate = NULL, annotatedLocation = NULL, etag = NULL, platformVersion = NULL, diskVolumeReports = NULL, activeTimeRanges = NULL, firmwareVersion = NULL, ethernetMacAddress0 = NULL, kind = NULL, deviceFiles = NULL, annotatedAssetId = NULL, macAddress = NULL, osVersion = NULL, status = NULL, cpuStatusReports = NULL, ethernetMacAddress = NULL, orderNumber = NULL, recentUsers = NULL, tpmVersionInfo = NULL, supportEndDate = NULL, lastSync = NULL, annotatedUser = NULL, notes = NULL, dockMacAddress = NULL, willAutoRenew = NULL, autoUpdateExpiration = NULL, orgUnitPath = NULL, bootMode = NULL, lastEnrollmentTime = NULL, model = NULL, serialNumber = NULL, systemRamTotal = NULL, lastKnownNetwork = NULL, systemRamFreeReports = NULL, meid = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.chromeosdevices.update']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
