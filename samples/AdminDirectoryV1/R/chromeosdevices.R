	...
	#' @export
	chromeosdevices.action <- function(resourceId, customerId, deprovisionReason = NULL, action = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.chromeosdevices.action']]$scopes), return_response = F){
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	chromeosdevices.list <- function(customerId, projection = NULL, orgUnitPath = NULL, sortOrder = NULL, maxResults = NULL, orderBy = NULL, query = NULL, pageToken = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.chromeosdevices.list']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	chromeosdevices.patch <- function(customerId, deviceId, projection = NULL, activeTimeRanges = NULL, lastEnrollmentTime = NULL, ethernetMacAddress0 = NULL, orgUnitPath = NULL, model = NULL, tpmVersionInfo = NULL, willAutoRenew = NULL, osVersion = NULL, dockMacAddress = NULL, bootMode = NULL, manufactureDate = NULL, annotatedAssetId = NULL, notes = NULL, status = NULL, orderNumber = NULL, autoUpdateExpiration = NULL, platformVersion = NULL, firmwareVersion = NULL, kind = NULL, diskVolumeReports = NULL, macAddress = NULL, annotatedLocation = NULL, annotatedUser = NULL, meid = NULL, recentUsers = NULL, ethernetMacAddress = NULL, lastKnownNetwork = NULL, deviceFiles = NULL, systemRamTotal = NULL, lastSync = NULL, etag = NULL, cpuStatusReports = NULL, systemRamFreeReports = NULL, supportEndDate = NULL, serialNumber = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.chromeosdevices.patch']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	chromeosdevices.update <- function(deviceId, customerId, projection = NULL, activeTimeRanges = NULL, lastEnrollmentTime = NULL, ethernetMacAddress0 = NULL, orgUnitPath = NULL, model = NULL, tpmVersionInfo = NULL, willAutoRenew = NULL, osVersion = NULL, dockMacAddress = NULL, bootMode = NULL, manufactureDate = NULL, annotatedAssetId = NULL, notes = NULL, status = NULL, orderNumber = NULL, autoUpdateExpiration = NULL, platformVersion = NULL, firmwareVersion = NULL, kind = NULL, diskVolumeReports = NULL, macAddress = NULL, annotatedLocation = NULL, annotatedUser = NULL, meid = NULL, recentUsers = NULL, ethernetMacAddress = NULL, lastKnownNetwork = NULL, deviceFiles = NULL, systemRamTotal = NULL, lastSync = NULL, etag = NULL, cpuStatusReports = NULL, systemRamFreeReports = NULL, supportEndDate = NULL, serialNumber = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.chromeosdevices.update']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
